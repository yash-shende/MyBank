...
.showben a:hover{
   ...
   <script>
      function checkAccNum(){        
        let acc_num = document.getElementById("acNo").value;
        if(acc_num.length != 12){
          document.getElementById("submit-btn").disabled = true; 
          document.getElementById("acNo").style="border:solid 4px red;"        
          window.alert("Account Number should be of 12 digits  ") ;
        }   
        else{
          document.getElementById("submit-btn").disabled = false; 
          document.getElementById("acNo").style="border:solid 0px ;" 
        }     
      }
   </script>
</head>
...
<div class="row">               
       <div class="col-md-4">
          ...
          <input type="text" onchange="lenCheck()"  class="form-control" maxlength="11" value="<?php echo $_SESSION['acNo'];?>" disabled>
       </div> 
</div>       
<div class="row">               
       <div class="col-md-4">
...
<div class="row">               
       <div class="col-md-4">
          <label>Bank's A/C No:</label><span class="error">*</span>
          <input type="Number" onchange="checkAccNum()" id="acNo" name="benacno" placeholder="Beneficiary A/C No" class="form-control" pattern="\d*" maxlength="" required>
       </div> 
</div>       
<div class="row">               
       <div class="col-md-4">
...
<div class="row">
   <div class="col-md-4">
   <input type="submit" id="submit-btn"name="addben" value="Add Beneficiary"  class="btn btn-primary">
   </div>
</div>   
</div>
<div class="showben">
