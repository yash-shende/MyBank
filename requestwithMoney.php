...
<title>History Withdraw Money</title>
...
<p>This page shows the requests made by the user to their bank for withdrawing certain amount of money to their account</p>

<h3>Requests made to the bank for withdrawing money:</h3>
<table>
<tr>
...
$sql="SELECT * FROM duptransaction WHERE remacno='$acno' AND type1='withdraw' ";
...
if(mysqli_query($conn,$sql))
{
   if(mysqli_num_rows($result) > 0)
   {
      ...
      {
          echo "<tr><td>".$row["debit"]."</td><td>".$row["date1"];
      }
      echo "</table>";
   }
   else
